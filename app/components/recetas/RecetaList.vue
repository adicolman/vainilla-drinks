  ...
  <div>
    ...
    <Transition name="filters">
      <div v-if="showFilters" class="lg:hidden mb-4 p-4 bg-white rounded-xl border border-sand-200/60 space-y-3">
        ...
        <AppSelect v-model="filterEstado" label="Estado" :options="estadoOptions" />
        <button v-if="hasActiveFilters" class="text-[12px] text-brand-600 hover:text-brand-950 font-medium" @click="clearFilters">
          Limpiar filtros
        </button>
      </div>
    </Transition>
